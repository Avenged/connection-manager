...
namespace ConnectionManager.Services
{
    ...
    public sealed class ViewLifetimeControl
    {
        ...
        private void FinalizeRelease()
        {
            ...
            if (justReleased)
            {
                ...
                {
                    // For more information about using Multiple Views, see https://github.com/Microsoft/WindowsConnectionManagerStudio/blob/release/docs/UWP/features/multiple-views.md
